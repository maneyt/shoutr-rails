...
ActiveRecord::Schema.define(version: 20140630183725) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "follow_unique_constraint", unique: true, using: :btree
